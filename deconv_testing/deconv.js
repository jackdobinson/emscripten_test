...
function send_to_js_canvas(ptr,size,width,height) { console.log("TESTING EM_ASM"); console.log(ptr, size, width, height); let im_data = new ImageData(new Uint8ClampedArray(Module.HEAPU8.buffer, ptr, size), width, height); scratch_canvas.width = width; scratch_canvas.height = height; scratch_canvas_ctx.imageSmoothingEnabled = false; scratch_canvas_ctx.putImageData(im_data, 0, 0); }
...
var dynCall_iiiiiiiiiiiiiii = Module['dynCall_iiiiiiiiiiiiiii'] = createExportWrapper('dynCall_iiiiiiiiiiiiiii', 15);
